...
@section('content')
				...
				<div id="content" class="clearfix">
						<div id="left-area" class="clearfix">
								...
								<div class="post">
										<h1 class="single-post-title">Sweet maple and a layer of nuts in this buttery dessert makes Christmas oh so special!</h1>
										...
										<div class="single-img-box">
												<a href="{{ asset('public/user/images/blog/post_3.jpg') }}" rel="prettyPhoto" title="Image">
                                ...
                                <div id="respond">
		                                ...
		                                <form action="#">
				                                ...
				                                <p>
				                                		<textarea name="message" id="message" cols="30" rows="10">Type your comments here</textarea>
				                                </p>
				                                <p><input type="submit" name="comment_submit" value="Submit Now" class="readmore" /></p>
		                                </form>
								</div>

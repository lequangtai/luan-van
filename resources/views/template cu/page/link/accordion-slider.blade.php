@extends('User.master')
@section('title','Trang accordion-slider')
@section('content')
						...
						<div id="slider" class="accordionSlider">
								<div id="slider_frame" class="accor-slider">
										<ul id="accordion-slider" class="sm">
												<li>
														<a href="#"><img src="{{ asset('public/user/images/slider/accor_1.jpg') }}" alt="Image" /></a>
												</li>
												<li>
														<a href="#"><img src="{{ asset('public/user/images/slider/accor_2.jpg') }}" alt="Image" /></a>
												</li>
												<li>
														<a href="#"><img src="{{ asset('public/user/images/slider/accor_3.jpg') }}" alt="Image" /></a>
												</li>
												<li>
														<a href="#"><img src="{{ asset('public/user/images/slider/accor_4.jpg') }}" alt="Image" /></a>
												</li>
										</ul>
								</div>

@extends('User.master')
@section('title','Trang thumb-slide')
@section('content')
...
<div id="slider">
    <div class="thumb-slider-wrap">
        <div class="thumb-slider">
            <img src="{{ asset('public/user/images/slider/nivo_1.jpg') }}" alt="Image" />
            <img src="{{ asset('public/user/images/slider/nivo_2.jpg') }}" alt="Image" />
            <img src="{{ asset('public/user/images/slider/nivo_3.jpg') }}" alt="Image" />
            <img src="{{ asset('public/user/images/slider/nivo_4.jpg') }}" alt="Image" />
            <img src="{{ asset('public/user/images/slider/nivo_5.jpg') }}" alt="Image" />
            <img src="{{ asset('public/user/images/slider/nivo_6.jpg') }}" alt="Image" />
        </div>
    </div>

@extends('User.master')
@section('title','Trang right-slider')
@section('content')
        		...
        		<div id="content">
						...
						<div id="slider" class="slider2">
								<div class="most-rated">
										<div class="item">
												<a href="#" class="img-box"><img src="{{ asset('public/user/images/slider/left_1.jpg') }}" alt="Hotest" /></a>
								...
								<div class="slides right-slider">
										<ul>
												<li>
														<a href="#" class="img-box"><img src="{{ asset('public/user/images/slider/left_2.jpg') }}" alt="Hotest" /></a>
												...
												<li>
														<a href="#" class="img-box"><img src="{{ asset('public/user/images/slider/left_3.jpg') }}" alt="Hotest" /></a>
														<div class="slide-info">
												...
												<li>
														<a href="#" class="img-box"><img src="{{ asset('public/user/images/slider/left_1.jpg') }}" alt="Slider Image" /></a>
														<div class="slide-info">

@extends('User.master')
@section('title','Trang single-full')
@section('content')
						...
						<div id="left-area" class="clearfix full-wide">
								...
								<div class="single-imgs">
									<div class="single-img-box">
										<div class="recipe-single-img">
											<img src="{{ asset('public/user/images/blog/post_3.jpg') }}" alt="Image" />
										</div>
									</div>
									<div id="horiz_container_outer" class="small-img-cont">
											<ul id="horiz_container" class="small-imgs">
													<li><a rel="{{ asset('public/user/images/single-rec/recipe_1.jpg') }}"><img src="{{ asset('public/user/images/single-rec/thumbs/recipe_1.jpg') }}" alt="Image" /></a></li>
													<li><a rel="{{ asset('public/user/images/single-rec/recipe_2.jpg') }}"><img src="{{ asset('public/user/images/single-rec/thumbs/recipe_2.jpg') }}" alt="Image" /></a></li>
													<li><a rel="{{ asset('public/user/images/single-rec/recipe_3.jpg') }}"><img src="{{ asset('public/user/images/single-rec/thumbs/recipe_3.jpg') }}" alt="Image" /></a></li>
													<li><a rel="{{ asset('public/user/images/single-rec/recipe_4.jpg') }}"><img src="{{ asset('public/user/images/single-rec/thumbs/recipe_4.jpg') }}" alt="Image" /></a></li>
													<li><a rel="{{ asset('public/user/images/single-rec/recipe_5.jpg') }}"><img src="{{ asset('public/user/images/single-rec/thumbs/recipe_5.jpg') }}" alt="Image" /></a></li>
													<li><a rel="{{ asset('public/user/images/single-rec/recipe_6.jpg') }}"><img src="{{ asset('public/user/images/single-rec/thumbs/recipe_6.jpg') }}" alt="Image" /></a></li>
													<li><a rel="{{ asset('public/user/images/single-rec/recipe_7.jpg') }}"><img src="{{ asset('public/user/images/single-rec/thumbs/recipe_7.jpg') }}" alt="Image" /></a></li>
													<li><a rel="{{ asset('public/user/images/single-rec/recipe_8.jpg') }}"><img src="{{ asset('public/user/images/single-rec/thumbs/recipe_8.jpg') }}" alt="Image" /></a></li>
													<li><a rel="{{ asset('public/user/images/single-rec/recipe_9.jpg') }}"><img src="{{ asset('public/user/images/single-rec/thumbs/recipe_9.jpg') }}" alt="Image" /></a></li>
													<li><a rel="{{ asset('public/user/images/single-rec/recipe_10.jpg') }}"><img src="{{ asset('public/user/images/single-rec/thumbs/recipe_10.jpg') }}" alt="Image" /></a></li>
											</ul>
											<div class="carnav">
								...
								<div class="info-left">
										...
										<h3 class="blue">Recipe Comments and Reviews
												<span class="note">Please feel free to rate &amp; review this recipe</span>
										</h3>
										<span class="w-pet-border"></span>

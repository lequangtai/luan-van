			...
			<div id="container-sidebar"><!-- sidebar content container -->
				...
				<div class="type-post">
					...
					<div class="blog-post-background">
						...
						<div class="post-details-meta">Posted on <a href="#">{!! $tt['created_at'] !!}</a> by <a href="{!! url('chi-tiet-dia-diem/'.$dd['id'])!!}">{!! $dd['tendiadiem'] !!}</a></div>
			...
			<div id="sidebar">
				<div class="widget content-container">
					...
					<ul>
						...
						<li><a href="{!! url('loai-tin/'.$lt['id'])!!}">{!! $lt['tenloaitin'] !!}</a></li>
						@endforeach
					</ul>
				</div>

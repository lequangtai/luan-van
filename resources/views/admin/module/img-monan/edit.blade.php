      ...
      <div class="col-xs-12">
        <div class="box box-default">
          ...
          <div class="form-group ">
              ...
              <select class="col-sm-6 select2" name="sltCate"><?php menuMulti6($monan); ?>
           ...
           <div class="form-group">
              ...
              <div class="col-sm-9">
               <img src="{!! isset($imgmonan["images"]) ? asset('public/uploads/news/'.$imgmonan["images"]) :asset('public/lv17_admin/templates/images/nophoto.png') !!}" width="100px" />
              <input type="hidden" name="fImageCurrent" value="{!! $imgmonan["images"] !!}">
